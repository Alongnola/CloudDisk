...
<body>
  ...
  <a href="${pageContext.request.contextPath}/searchUserfile" >我的主页</a>&nbsp;
   ...
   <font style="font-size: 25px; background-color: silver;">您可以发email至gmnsjxmm@qq.com询问，后续会开通密码找回功能</font><br/>
